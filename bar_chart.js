function BarChart(
  data,
  {
    x = (data,index) => index, // given d in data, returns the (ordinal) x-value
    y = (data) => data, // given d in data, returns the (quantitative) y-value
    ...
    color = "#FFDF43", // bar fill color
    duration: initialDuration = 750, // transition duration, in milliseconds
